---
title: ''
description: 'Indie video game developer.'
pubDate: 'Jan 01 2026'
heroImage: ''
section: 'landing'
---
...
.prose {
	...
	background-image: url("https://www.playmakina.com/background-grayscale.jpg"), radial-gradient(var(--white), var(--white), rgb(var(--black)), rgb(var(--black))), linear-gradient(to bottom, var(--accent), yellow);
...
<div align="center">
	...
	<a class="btn btn-primary" href="https://www.playmakina.com/en/makimakulo/" target="_blank">
		Blog
	</a>
</div>
